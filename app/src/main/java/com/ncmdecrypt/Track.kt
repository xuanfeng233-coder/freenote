 ...
 * [mediaStoreUri] is the public MediaStore copy, so tag edits can be mirrored back to it.
 * [publicPath] is the saved copy in the user's FreeNote folder (direct File path), re-synced
 * after a tag edit. One of [mediaStoreUri] / [publicPath] is set depending on how it was saved.
 */
data class Track(
    val id: String,
    val filePath: String,
